            ...
            <React.Fragment>
                {
                    ...
                    <div style={{width:'80%',marginLeft:'40px'}}>
                        <SingleComment refreshFunction={props.refreshFunction} postId={props.videoId}/>
    ...
    return (
        <div>
            {ChildCommentNumber>0 &&
                 <p style={{fontSize:'14px',margin:0,color:'gray'}} onClick={onHandleChange}>View 1 more comment(s)</p>
            }
            {OpenReplyComments &&
